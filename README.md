...
In this package, we implement our VD-GAN using Pytorch, and train/test our model on CAS-PEAL (disguise) dataset. Furthermore, we provide the modelLight.py to present the new network structures of VD-GAN using the LightCNN feature extractor.  
